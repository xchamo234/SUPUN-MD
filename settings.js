...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'SUPUN-MD=yFEVyBoI#aOfQGEj3XDVIMgGPL_Qm7SgzghtLI1swcC5h9LVzPJ0' : process.env.SESSION_ID,
...
FOOTER: process.env.FOOTER === undefined ? "> ᴄ.ɴ ᴍᴏᴠɪᴇ ʜᴜʙ ʙʏ 𝙭𝘾𝙝𝙖𝙢𝙤!☁️" : process.env.FOOTER,
